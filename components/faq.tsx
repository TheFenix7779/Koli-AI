...
const FAQ = [
  ...
  {
    q: "יש לנו כבר מזכירה — קולי מחליפה אותה?",
    a: "לא, ולא בגלל נימוס. קולי טובה בשיחות שחוזרות על עצמן: שעות, מחירים, זימון תור. היא פחות טובה בכל מה שדורש שיקול דעת, רגישות או היכרות עם מטופל ותיק — ושם מזכירה אנושית עדיפה בפער. ברוב העסקים שעובדים איתנו קולי מכסה את השעות והעומסים שאין בהם מענה, והמזכירה ממשיכה לעשות את מה שהיא עושה הכי טוב.",
  },
  {
  ...
  },
  {
    ...
    a: "ברירת המחדל היא Google Calendar לתורים ו־Google Sheets לתיעוד, עם עדכונים במייל לצוות. אם אתם כבר עובדים עם יומן אחר או עם CRM, קולי מתחברת אליו — נעבור על זה בשיחת ההיכרות. אין צורך להחליף כלים.",
  },
  {
