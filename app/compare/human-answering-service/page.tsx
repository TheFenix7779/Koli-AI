    ...
    <>
      ...
      >
        <Section heading="מה זה מענה אנושי חיצוני">
          <p>
            <strong>
              מוקד מענה אנושי מתאים כששיחות דורשות שיקול דעת; מזכירה AI מתאימה כשהן חוזרות על
              עצמן.
            </strong>{" "}
            זו התשובה הקצרה, וכל השאר הוא פירוט של מתי כל אחד מהם נכון.
          </p>
          <p>
            מוקד מענה אנושי הוא שירות שבו נציגים אמיתיים עונים לשיחות בשם העסק שלכם, לפי תסריט
            שהגדרתם. מפנים אליהם את הקו — נייח או נייד — והם מוסרים הודעות, מסננים פניות ולפעמים גם מתאמים פגישות. ההודעות מגיעות אליכם במייל, ב־SMS או במערכת של המוקד.
